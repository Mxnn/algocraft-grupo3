...
public abstract class UnidadAgresora extends Unidad {
    ...
    public UnidadAgresora(Jugador propietario, Vitalidad vitalidad, int tiempoDeConstruccion, int cupoDeTransporte, int vision, int suministro, RangoAtaque rangoAtaque, Danyo danyo, Costo costo) throws ExcepcionNoHaySuministrosDisponibles, ExcepcionRecursosInsuficientes {
        super(propietario, vitalidad, tiempoDeConstruccion, cupoDeTransporte, vision, suministro, costo);
        this.rangoAtaque = rangoAtaque;
        this.danyo = danyo;
    }

    public void atacar(Parcela parcela) throws ExcepcionParcelaVacia {
