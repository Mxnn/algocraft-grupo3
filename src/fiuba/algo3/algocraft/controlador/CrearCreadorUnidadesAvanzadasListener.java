...
public class CrearCreadorUnidadesAvanzadasListener implements ActionListener {
	...
	public CrearCreadorUnidadesAvanzadasListener(Juego modelo, int x, int y){
		this.modelo = modelo;
		this.x = x;
		this.y = y;
	}
    ...
    public void actionPerformed(ActionEvent e) {
        try {
			this.modelo.getJugadorQueJuega().crearCreadorDeUnidadesAvanzadas(this.modelo.getMapa(), new Coordenada(this.x, this.y));
