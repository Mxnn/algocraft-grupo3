...
public class CrearCreadorUnidadesMagicasListener implements ActionListener {
	...
	public CrearCreadorUnidadesMagicasListener(Juego modelo, int x, int y){
		this.modelo = modelo;
		this.x = x;
		this.y = y;
	}
    ...
    public void actionPerformed(ActionEvent e) {
        try {
			this.modelo.getJugadorQueJuega().crearCreadorDeUnidadesMagicas(this.modelo.getMapa(), new Coordenada(this.x, this.y));
