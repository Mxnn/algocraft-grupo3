...
public class CrearAdicionalDeSuministroListener implements ActionListener {
	...
	private int x;
	private int y;
	public CrearAdicionalDeSuministroListener(Juego modelo, int x, int y){
		this.modelo = modelo;
		this.x = x;
		this.y = y;
	}
    ...
    public void actionPerformed(ActionEvent e) {
        try {
			this.modelo.getJugadorQueJuega().crearAdicionalDeSuministro(this.modelo.getMapa(), new Coordenada(this.x, this.y));
