...
public class CrearExtractorGasListener implements ActionListener {
	...
	private int x;
	private int y;
	public CrearExtractorGasListener(Juego modelo, int x, int y) {
		this.modelo = modelo;
		this.x = x;
		this.y = y;
	}
	...
	public void actionPerformed(ActionEvent e) {
		try {
			this.modelo.getJugadorQueJuega().crearExtractorGas(this.modelo.getMapa(), new Coordenada(this.x, this.y));
